	...
	if (request.getParameter("val_nume") != null
		...
		if (usr_role == Right.ADMINISTRATOR) {
			if (request.getParameter("usage").equals("0")) {
				...
				//newUser.setCvLocation(newUser.getCvLocation());
				try {
...
<title><% if (usage == 0) out.print("Adaugare utilizator"); else out.print("Editare cont");%></title>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3" align="center" background="newStyle/images/graymidbottom.gif">
	...
	<tr height="450">
		...
		<table width="382" border="0" align="center" cellpadding="5"
			...
			<tr>
				<td width="172" class="contents">Nume</td>
			...
			<tr>
				<td class="contents">Data nasterii</td>
			...
			<tr>
				<td class="contents">Functie didactica</td>
			...
			<tr>
				...
				<td width="247" height="0" valign="top" class="contents" id="field_doctor_din">din anul&nbsp;<input name=doctor_din_anul id ="hv1" type="text" class="field_value" size="7" MaxLength="4"
					<% 
			...
			<tr>
				<td valign="top" class="contents" style="padding-top: 8px;">Conducator
				doctorat</td>
				<td valign="top" class="field_value" id="field_conducator_doctorat"><input
					...
					<% if (usage == 1 && editu.isConducatorDoctorat()) out.print("checked"); 
						...
						if (usage == 0 || (usage == 1 && editu.getFunctieDidactica() != FunctieDidactica.CONFERENTIAR &&
							...
							out.print("disabled=\"true\"");
					%>></td>
				<td valign="top" class="field_value" id="field_doctoranzi_stagiu"><table><tr><td class="contents">La zi</td><td><input id="hv2" name="val_doctoranzi_zi" type="text" class="field_value" size="8" maxlength="2" 
				<% if (usage == 1 && editu.isConducatorDoctorat()) 
					out.print("value=\"" + editu.getDoctoranziStagiuZi() + "\""); 
					else out.print("disabled=\"true\"");
				%>
				></td></tr><tr><td class="contents">La FF</td><td><input id="hv3" name="val_doctoranzi_ff" type="text" class="field_value" size="8" maxlength="2" 
				<% if (usage == 1 && editu.isConducatorDoctorat()) 
			...
			<tr>
				<td valign="top" class="contents" style="padding-top: 8px;">Consultant</td>
			...
			<tr>
				...
				<td colspan="2" class="field_value"><input name="adauga"
					...
					onClick="valideaza_form()"> &nbsp;
					<% if (usage == 1) { %><input name="edit_cv"
					type="button" class="buton" value=" CV "
					onClick="window.open('cv.jsp?cvid=<%=request.getParameter("uid")%>','CV','height=150,width=405,status=0,directories=no,location=no,menubar=no,resizable=no,scrollbars=0,toolbar=no,left=400,top=400');">
					<% } %> 
					</td>
			</tr>
		</table>
		...
		<input type="hidden" id="cvurl" name="cvurl"
			value="<% if (usage == 1) out.print(editu.getCvLocation()); %>">
