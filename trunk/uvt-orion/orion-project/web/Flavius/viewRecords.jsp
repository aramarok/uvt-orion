...
<%
	...
	anyrecords = false;
	try{
	 List<Object> list1records = lService.getListRecordsOfAUser(usr_id, Lista1.class);
	 if ((list1records!=null) && (!list1records.isEmpty())){
		 ...
		 for (Object l : list1records){
			 i++;
			 String pag="\"editRecord.jsp?lista=1&record="+((Lista1)l).getIdLista1().toString()+"\"";
			 String pag2="\"deletedRecord.jsp?lista=1&record="+((Lista1)l).getIdLista1().toString()+"\"";
			 %>
			 	<TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list2records = lService.getListRecordsOfAUser(usr_id, Lista2.class);
	 if ((list2records!=null) && (!list2records.isEmpty())){
		 ...
		 for (Object l : list2records){
			 i++;
			 String pag="\"editRecord.jsp?lista=2&record="+((Lista2)l).getIdLista2().toString()+"\"";
			 String pag2="\"deletedRecord.jsp?lista=2&record="+((Lista2)l).getIdLista2().toString()+"\"";		 
			 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list3records = lService.getListRecordsOfAUser(usr_id, Lista3.class);
	 if ((list3records!=null) && (!list3records.isEmpty())){
		 ...
		 for (Object l : list3records){
			 i++;
			 String pag="\"editRecord.jsp?lista=3&record="+((Lista3)l).getIdLista3().toString()+"\"";			 			 
			 String pag2="\"deletedRecord.jsp?lista=3&record="+((Lista3)l).getIdLista3().toString()+"\"";
			 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list4records = lService.getListRecordsOfAUser(usr_id, Lista4.class);
	 if ((list4records!=null) && (!list4records.isEmpty())){
		 ...
		 for (Object l : list4records){
			 ...
			 i++;
			 String pag="\"editRecord.jsp?lista=4&record="+((Lista4)l).getIdLista4().toString()+"\"";			 
			 String pag2="\"deletedRecord.jsp?lista=4&record="+((Lista4)l).getIdLista4().toString()+"\"";			 
	    	 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list5records = lService.getListRecordsOfAUser(usr_id, Lista5.class);
	 if ((list5records!=null) && (!list5records.isEmpty())){
		 ...
		 for (Object l : list5records){
			 ...
			 String data=sdf.format(date);
			 i++;
			 String pag="\"editRecord.jsp?lista=5&record="+((Lista5)l).getIdLista5().toString()+"\"";			 			 
			 String pag2="\"deletedRecord.jsp?lista=5&record="+((Lista5)l).getIdLista5().toString()+"\"";			 			 
			 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list6records = lService.getListRecordsOfAUser(usr_id, Lista6.class);
	 if ((list6records!=null) && (!list6records.isEmpty())){
		 ...
		 for (Object l : list6records){
			 i++;
			 String pag="\"editRecord.jsp?lista=6&record="+((Lista6)l).getIdLista6().toString()+"\"";
			 String pag2="\"deletedRecord.jsp?lista=6&record="+((Lista6)l).getIdLista6().toString()+"\"";
			 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list7records = lService.getListRecordsOfAUser(usr_id, Lista7.class);
	 if ((list7records!=null) && (!list7records.isEmpty())){
		 ...
		 for (Object l : list7records){
			 i++;
			 String pag="\"editRecord.jsp?lista=7&record="+((Lista7)l).getIdLista7().toString()+"\"";
			 String pag2="\"deletedRecord.jsp?lista=7&record="+((Lista7)l).getIdLista7().toString()+"\"";
			 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list8records = lService.getListRecordsOfAUser(usr_id, Lista8.class);
	 if ((list8records!=null) && (!list8records.isEmpty())){
		 ...
		 for (Object l : list8records){
			 i++;
			 String pag="\"editRecord.jsp?lista=8&record="+((Lista8)l).getIdLista8().toString()+"\"";
			 String pag2="\"deletedRecord.jsp?lista=8&record="+((Lista8)l).getIdLista8().toString()+"\"";
			 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list9records = lService.getListRecordsOfAUser(usr_id, Lista9.class);
	 if ((list9records!=null) && (!list9records.isEmpty())){
		 ...
		 for (Object l : list9records){
			 ...
			 String data=sdf.format(date);
			 i++;
			 String pag="\"editRecord.jsp?lista=9&record="+((Lista9)l).getIdLista9().toString()+"\"";
			 String pag2="\"deletedRecord.jsp?lista=9&record="+((Lista9)l).getIdLista9().toString()+"\"";
			 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
...
<%
	try{
	 List<Object> list10records = lService.getListRecordsOfAUser(usr_id, Lista10.class);
	 if ((list10records!=null) && (!list10records.isEmpty())){
		 ...
		 for (Object l : list10records){
			 i++;
			 String pag="\"editRecord.jsp?lista=10&record="+((Lista10)l).getIdLista10().toString()+"\"";
			 String pag2="\"deletedRecord.jsp?lista=10&record="+((Lista10)l).getIdLista10().toString()+"\"";
			 %>
			 <TR ALIGN=CENTER bgcolor="#DFE8F0" 
			 	<% 
			 	if(i % 2 == 0){
