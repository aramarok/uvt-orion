...
public class FieldFilterDate extends FieldFilter 
{	
	public FieldFilterDate(String numeField, String nume_de_scena, String valoareField1, String valoareField2, String tipField, String extraStuff)
	{
	...
	public String getInsert()
	{
		if (isValid())
		{
			Date d = new Date(Date.parse(getValoareField1()));
	...
	protected long get_constraint(String constr) throws Exception
	{
		...
		{			
			...
			for (FieldFilter f : container())
				...
				{
					return Date.parse(f.getValoareField1());
				}
	...
	protected boolean checkExtraStuff()
	{
		...
		{			
			...
			{
				long d = Date.parse(getValoareField1());
				long dc1 = d, dc2 = d;
				int poz1, poz2;
				...
				cond2 = cons.substring(poz2, cons.indexOf(')')).trim();
