...
<table width="800" border="0" cellspacing="0" cellpadding="3"
	...
	<tr bgcolor="#B8CCDB" height="30">
		<td class="field_name" style="padding-right:50px;"><a class="aaction"
			href="login.jsp?logoff=1">Logout</a> <b>|</b> <a class="aaction"
			href="edit_user.jsp?uid=0">Adauga utilizator</a></td>
	</tr>
