...
<table width="800" border="0" cellspacing="0" cellpadding="3" align="center">
	...
	<tr bgcolor="#B8CCDB" height="30">
		<td class="field_name" style="padding-right: 50px;"><a
			class="aaction" href="login.jsp?logoff=1">Logout</a>
	<% 
		if (usr_role == Right.ADMINISTRATOR)
		{
			out.print(" <b>|</b> <a class=\"aaction\" href=\"users_list.jsp\">Lista utilizatori</a>"); 
			if (usage == 1)
				out.print(" <b>|</b> <a class=\"aaction\" href=\"edit_user.jsp?uid=0\">Adauga utilizator</a> ");
			out.print("</td>");
		}
	%> 
	</tr>
